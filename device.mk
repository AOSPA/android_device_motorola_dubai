...
DEVICE_FRAMEWORK_MANIFEST_FILE := device/motorola/dubai/framework_manifest.xml
...
DEVICE_MANIFEST_LAHAINA_FILES := device/motorola/dubai/manifest_lahaina.xml
DEVICE_MANIFEST_SHIMA_FILES := device/motorola/dubai/manifest_shima.xml
DEVICE_MANIFEST_YUPIK_FILES := device/motorola/dubai/manifest_yupik.xml
...
PRODUCT_COPY_FILES += \
    device/motorola/dubai/task_profiles.json:$(TARGET_COPY_OUT_VENDOR)/etc/task_profiles.json
